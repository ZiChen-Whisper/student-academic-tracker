...
import { Clock, Plus, Pencil, Trash2, User, ChevronRight, ChevronDown, Code, Users, School, GraduationCap, TrendingUp, CircleCheckBig, AlertTriangle, ShieldAlert, ShieldCheck, CalendarClock, Moon, BookOpen, HeartPulse, ClipboardCheck, Trophy, Medal, BarChart3, X, Loader2, Copy, Check, FileText, FileJson } from 'lucide-react';
...
function CopyButton({ item, useChinese = true }) {
  ...
  const getDropdownStyle = () => {
    ...
    // 下拉菜单右边缘与按钮右边缘对齐
    const dropdownWidth = 80; // min-width
    return {
      position: 'fixed',
      top: rect.bottom + 4,
